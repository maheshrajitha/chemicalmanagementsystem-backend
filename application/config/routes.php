...
$route['admin/sales/(:any)'] = 'Sales_Controller/index/$1';
...
$route['admin/employees/check-by-email/(:any)'] = 'Employees_Controller/check_employee_by_email/$1';
$route['admin/employees/get-by-id/(:any)'] = 'Employees_Controller/get_employee_by_id/$1';
$route['admin/sales/get-month-and-sales'] = 'Sales_Controller/get_month_and_sales';
$route['admin/employees/check-by-emp-no/(:any)'] = 'Employees_Controller/check_employee_by_emp_no/$1';
$route['admin/orders/order/(:any)'] = 'Sales_Controller/get_order_by_order_number/$1';
$route['translate_uri_dashes'] = FALSE;
